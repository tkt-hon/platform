...
function behaviorLib.PositionSelfTraverseLane(botBrain)
	...
	--if botBrain.myName == 'ShamanBot' then bDebugEchos = true bDebugLines = object.bDebugLines end
...
function behaviorLib.PathLogic(botBrain, vecDesiredPosition)
	...
	--if object.myName == "ShamanBot" then bDebugLines = object.bDebugLines bDebugEchos = true end
...
function behaviorLib.PushExecute(botBrain)
	...
	--if botBrain.myName == 'ShamanBot' then bDebugLines = object.bDebugLines end
...
function behaviorLib.UseHealthRegenExecute(botBrain)
	...
	--[[
	if object.myName == "Bot1" then
		bDebugLines = object.bDebugLines
	end
	--]]

...
behaviorLib.StartingItems = { "2 Item_MinorTotem", "Item_RunesOfTheBlight", "Item_MarkOfTheNovice", "Item_HealthPotion", "Item_PretendersCrown" }
behaviorLib.LaneItems = { "Item_GraveLocket", "Item_Marchers", "Item_MysticVestments", "Item_Steamboots" }
behaviorLib.MidItems = { "Item_FrostfieldPlate", "Item_SacrificialStone"}
behaviorLib.LateItems = { "Item_Energizer" }
